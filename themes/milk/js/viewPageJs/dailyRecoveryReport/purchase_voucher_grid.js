    ...
    $scope.init = function (company_id , riderList , getDialyDeliveryCustomerURL ,googleMapURL , saveDeliveryURL) {
     ...
     $scope.selectRiderOnChange = function(productID){
         ...
         if(productID ==''){
             ...
             $http.post($scope.getDialyDeliveryCustomerURL+"_acount_purchase" ,RiderObject)
                 .success(function(reponseData , status ){
                           $scope.list_data = reponseData.list;
                           $scope.grand_total = reponseData.total;
                           $scope.lable = reponseData.lable;
     ...
     $scope.save_customer_payment_function = function(){
         ...
         var send_data ={
             ...
             'list_data':$scope.list_data,
             'total_amount':$scope.grand_total,
             'payment_type_id'  :$scope.payment_type_id

         }

         $http.post($scope.getDialyDeliveryCustomerURL+"_purchase_payment_save_vocher" ,send_data)
             .success(function(reponseData , status ){
