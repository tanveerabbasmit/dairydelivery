...
app.controller('manageZone', ['$scope', '$http', '$filter', function ($scope, $http, $filter) {
    ...
    $scope.init = function (allow_delete , zoneList, companyBranchList , saveNewZoneURL ,editZoneURL , deleteURL) {
        ...
        $scope.zoneObject = {'product_category_id':'0','category_name':'' , 'companyBranch':'1', 'is_active':'1' ,'is_deleted':'1'}
        $scope.search = '';
        $scope.searchBar = ''
    ...
    $scope.addnewZone = function(){
        ...
        $scope.zoneObject = {'product_category_id':'0' , 'category_name':''}
    };
    ...
    $scope.addZone = function () {
      ...
      $scope.zoneList.push({"product_category_id":"0","category_name":"","company_id":"1","update":true});
    }
