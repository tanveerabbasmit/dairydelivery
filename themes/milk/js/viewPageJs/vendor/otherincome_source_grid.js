...
app.controller('manageZone', ['$scope', '$http', '$filter', function ($scope, $http, $filter) {
    ...
    $scope.init = function (allow_delete , zoneList, companyBranchList , saveNewZoneURL ,editZoneURL , deleteURL) {
        ...
        $scope.zoneObject = {'employee_id':'0','employee_name':'' ,'phone_number':'', 'company_id':'1',  'status':'1' ,'notification_alert':'1'}
        $scope.search = '';
        $scope.searchBar = ''
    ...
    $scope.addnewZone = function(){
        ...
        $scope.zoneObject = {'other_income_source_id':'0','other_income_source_name':'' ,'phone_number':'', 'company_id':'1',  'status':'1' ,'notification_alert':'1'}
    };
    ...
    $scope.addZone = function () {
      $scope.zoneList.push({'other_income_source_id':'0','other_income_source_name':'' ,'phone_number':'', 'company_id':'1',  'status':'1' ,'notification_alert':'1','update':true});
    }
