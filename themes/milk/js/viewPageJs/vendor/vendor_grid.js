...
app.controller('manageZone', ['$scope', '$http', '$filter', function ($scope, $http, $filter) {
    //INITIALIZATION ===============================================================
    $scope.init = function (vendor_type_list ,allow_delete , zoneList, companyBranchList , saveNewZoneURL ,editZoneURL , deleteURL) {

        $scope.vendor_type_list = vendor_type_list;
        ...
        $scope.zoneObject = {'vendor_type_id':'0','name':'' ,'phone_no':'', 'companyBranch':'1', 'is_active':'1' ,'is_deleted':'1'}
        $scope.search = '';
        $scope.searchBar = ''
    ...
    $scope.get_block_list =function(zone){
        $http.post($scope.saveNewZoneURL+"_get_vendor_list")
            .success(function (data, status, headers, config) {
    ...
    $scope.setReset = function() {
        $scope.zoneObject = {'name':'' , 'companyBranch':'1', 'is_active':'1' ,'is_deleted':'1','payment_alert':'0','provide_bill_alert':'0','is_active':'1'}
    }

    $scope.addZone = function () {
      $scope.zoneList.push({'vendor_type_id':'0',"vendor_id":"0","vendor_name":"",'payment_alert':'0','provide_bill_alert':'0','is_active':'1',"update":true});
    }
