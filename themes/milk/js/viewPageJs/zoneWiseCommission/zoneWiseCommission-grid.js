...
app.controller('manageZone', ['$scope', '$http', '$filter', function ($scope, $http, $filter) {
    //INITIALIZATION ===============================================================
    $scope.init = function (productList ,allow_delete , zoneList, companyBranchList , saveNewZoneURL ,editZoneURL , deleteURL) {
    ...
    $scope.saveZone = function(zone){
        ...
        $http.post($scope.editZoneURL+'_SaveCommission', zone)
            .success(function (data, status, headers, config) {

                zone.updateMode = false;
