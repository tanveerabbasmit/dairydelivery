...
app.controller('clintManagemaent', ['$scope', '$http', '$filter', function ($scope, $http, $filter) {
    //INITIALIZATION ===============================================================
    $scope.init = function (aleRepsList ,reasonList,blockList,areaList ,allow_delete  , CategoryList ,companyID , ClientOneObject , preferedTimeList , frequencyList , productCount ,
    ...
    $scope.changesaleRape =function(client){
          ...
          id = client.sales_reps_id ;
           ...
           angular.forEach($scope.aleRepsList , function (value ,key) {
