...
app.controller('clintManagemaent', ['$scope', '$http', '$filter', function ($scope, $http, $filter) {
    //INITIALIZATION ===============================================================
    $scope.init = function ( getCategoryLis,clientList , getClientLedgherReportURL){
            ...
            if(false){
                ...
                $http.post( $scope.getClientLedgherReportURL , data)
                    .success(function(responce , data){
                        ...
                        // $scope.all_data  =responce;

                        $scope.new_Customer = responce.new_Customer.finalResult ;

                        $scope.new_customer_box_data = responce.new_Customer.box_data ;

                        $scope.drop_Customer_list = responce.drop_Customer.finalResult ;
                        $scope.drop_Customer_list_box_data = responce.drop_Customer.box_data ;

                        $scope.sample_Customer = responce.sample_Customer.finalResult ;
                        $scope.sample_Customer_box_data = responce.sample_Customer.box_data ;

                        $scope.reportLoader = false;

                        $scope.load_data_show =true ;
