...
app.controller('manageZone', ['$scope', '$http', '$filter', function ($scope, $http, $filter) {
    //INITIALIZATION ===============================================================
    $scope.init = function (zoneList, companyBranchList , saveNewZoneURL ,editZoneURL , deleteURL) {
        ...
        $scope.zoneObject = {'category_name':'' ,'color_name':'', 'companyBranch':'1', 'is_active':'1' ,'is_deleted':'1'}
    ...
    $scope.addnewZone = function(){
        ...
        $scope.zoneObject = {'category_name':'' ,'color_name':'black', 'companyBranch':'1', 'is_active':'1' ,'is_deleted':'1'}
    };
    ...
    $scope.setReset = function() {
        $scope.zoneObject = {'category_name':'' , 'companyBranch':'1', 'is_active':'1' ,'is_deleted':'1'}
    }
