...
riderDailyStockGridModule.controller('riderDailyStockGridCtrl', ['$scope', '$http', '$filter', function ($scope, $http, $filter , $timeout) {
    //INITIALIZATION ===============================================================
    $scope.init = function (payment_term , category_list , year ,monthNum ,fiveDayAgo ,  company_id , riderList , getDialyDeliveryCustomerURL ,googleMapURL , saveDeliveryURL) {
        ...
        $scope.payment_term_list= payment_term;
    ...
    $scope.selectRiderOnChange = function(riderid){
        ...
        if(riderid ==''){
            ...
            $http.post($scope.getDialyDeliveryCustomerURL+"_date_range_wise" ,RiderObject)
