...
riderDailyStockGridModule.controller('riderDailyStockGridCtrl', ['$scope', '$http', '$filter', function ($scope, $http, $filter , $timeout) {
    //INITIALIZATION ===============================================================
    $scope.init = function (main_heading, fiveDayAgo ,  company_id , riderList , getDialyDeliveryCustomerURL ,googleMapURL , saveDeliveryURL) {
         ...
         $scope.main_heading= main_heading;
         ...
         if(false){
             ...
             $http.post($scope.getDialyDeliveryCustomerURL ,RiderObject)
                 .success(function(reponseData , status ){
                     ...
                     $scope.grand_total = reponseData.grand_total;
                     $scope.quantity_amount_sale_list = reponseData.list;
                     $scope.grand_total_quantity = reponseData.grand_total_quantity;
                     $scope.imageLoading = false;
