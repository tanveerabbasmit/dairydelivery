...
app.controller('clintManagemaent', ['$scope', '$http', '$filter', function ($scope, $http, $filter) {
    //INITIALIZATION ===============================================================
    $scope.init = function (payment_term_list , company_name, company_id , riderList , clientList , getClientLedgherReportURL ,oneCustomerAmountListallCustomerList){
    ...
    $scope.getCustomerLedgerReportFunction = function(){
        ...
        if($scope.startDate >$scope.endDate ){
            ...
            if($scope.riderClientObject == '0' && $scope.SelectedCustomer == 'Select Cutomer' && $scope.payment_term_id == '0'){

                $scope.taskMessage = 'Please Select Rider OR Customer OR Payment Term';
                document.getElementById("alertMessage").style.display = "block";
                setTimeout(function(){
                        document.getElementById("alertMessage").style.display = 'none';
                    },
                ...
                if(totalCustomer>0){
                    ...
                    alert('There is no customer for search');
                }
  ...
  $scope.chek_even_odd = function(index){
  ...
  $scope.table_td_color =function (index){
      if (index%2 == 0){
          return 'white';
      }else {
          return '#f1f1f3';
