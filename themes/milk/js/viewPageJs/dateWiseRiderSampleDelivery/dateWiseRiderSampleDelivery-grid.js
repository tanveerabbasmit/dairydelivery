         ...
         if($scope.product_id=='0'){
             ...
             $http.post($scope.getDialyDeliveryCustomerURL ,RiderObject)
                 .success(function(reponseData , status ){
                     ...
                     $scope.customer_list = reponseData.sampleCustomer_new.customer_list ;
                     $scope.reciable = reponseData.sampleCustomer_new.reciable ;
                     $scope.total = reponseData.sampleCustomer_new.total ;
                     $scope.total_quantity_sum = reponseData.sampleCustomer_new.total_quantity_sum
                     $scope.spacial_order_list = reponseData.spacial_order_list
