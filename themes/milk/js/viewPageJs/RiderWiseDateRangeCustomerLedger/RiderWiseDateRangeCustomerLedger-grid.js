...
riderDailyStockGridModule.controller('riderDailyStockGridCtrl', ['$scope', '$http', '$filter', function ($scope, $http, $filter , $timeout) {
    //INITIALIZATION ===============================================================
    $scope.init = function (payment_term_list ,paid_month,endDate ,rider_id , fiveDayAgo ,  company_id , riderList , getDialyDeliveryCustomerURL ,googleMapURL , saveDeliveryURL) {
       ...
       $scope.endDate =  endDate;
        ...
        $scope.paid_month = paid_month;
        $scope.payment_term_id = '0';

        $scope.selectRiderOnChange($scope.selectRiderID);
    }
