 ...
 * Time: 3:28 PM
 */
class count_demand_quantity_for_future
{

    public static function getOneCustomerTodayIntervalSceduler_with_date_future_date_for_demand($product_id ,$todayDate,$lientID_list){
        date_default_timezone_set("Asia/Karachi");
         $company_id = Yii::app()->user->getState('company_branch_id');


         if(is_array($lientID_list)){
             $clientObject = $lientID_list;
    ...
    public static function getTodayDeliveryCountWeeklyRegularAndSpecial_demandCount($product_id ,$todaydate,$lientID_list){
    ...
    public static function getTodaySpecialOrder_demandCount($product_id ,$todaydate,$lientID_list){
