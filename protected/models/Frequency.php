...
class Frequency extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('day_name', 'required'),
			array('day_name', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('frequency_id, day_name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'clientProductFrequencies' => array(self::HAS_MANY, 'ClientProductFrequency', 'frequency_id'),
		);
	}
