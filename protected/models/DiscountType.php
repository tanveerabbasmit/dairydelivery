...
class DiscountType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('discount_type_name, company_id', 'required'),
			array('company_id', 'numerical', 'integerOnly'=>true),
			array('discount_type_name', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('discount_type_id, discount_type_name, company_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('discount_type_name',$this->discount_type_name,true);
