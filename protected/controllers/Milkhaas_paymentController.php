...
class Milkhaas_paymentController extends Controller
{
    ...
    public function actionreturn_page(){
        ...
        $responce_data['url'] = 'http://dairydelivery.conformiz.com/Milkhaas_payment/sandbox_accounts?client_id='.$client_id;
        if($post){
            ...
            $new_genrated_hash= secure_hash_data::get_secure_hash_on_return_page_testing($post);
