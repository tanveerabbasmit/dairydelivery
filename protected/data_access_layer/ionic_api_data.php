...
class ionic_api_data
{
    public static function getRiderDialyDeliveryReport_for_ionic_dashborad($client_id,$company_id,$todaydate){




        $show_only_schedual_product =  1;
