...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/PosDateRangeStockRecived/payment_ledger_grid.js"></script>
...
<div  id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">
    <div ng-controller="riderDailyStockGridCtrl" ng-init='init(<?php echo $data ?> ,"<?php echo Yii::app()->createAbsoluteUrl('Paymentnew/base'); ?>")'>
        <div class="tabbable">
            ...
            <div class="tab-content">
                ...
                <div class=" active" id="tab_1" style="margin: 10px">
                    <Span style="font-size: 200%;margin-right: 15px">Type :</Span>

                    <label class="radio-inline" ng-repeat="list in vendor_type">
                        <input ng-click="get_vendor_list(vendor_type_id)" ng-model="vendor_type_id" type="radio" name="optradio" value="{{list.vendor_type_id}}" >{{list.vendor_type_name}}
                    </label>
               </div>
                ...
                <div class=" active" id="tab_1" style="margin: 10px">
                    ...
                    <select   id="vendor_id_value" ng-model="vendor_id" class="form-control select2 input-sm" style="float: left ; width: 17% ;margin-left: 10px;margin-right: 10px">
                        ...
                        <option value="{{list.vendor_id}}" ng-repeat="list in vendor_list_type_wise">{{list.vendor_name}}</option>
                    </select>
                    ...
                    <table id="customers">
                        ...
                        <tr ng-repeat="list in list_data">
                            ...
                            <td style="text-align: right"><span ng-bind="list.item_name"></span> </td >
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <!--<td style="text-align: right"><span ng-bind="total_balance"></span></td>-->
                        </tr>
