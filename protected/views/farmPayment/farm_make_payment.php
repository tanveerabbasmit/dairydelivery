...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/farmpayment/farmpayment_grid.js"></script>
                    ...
                    <div class="col-lg-12" style="background-color: 	honeydew;" >
                        <div class="col-lg-6">
                            ...
                            <div class="col-lg-8 ">
                                ...
                                <select id="target_change_payment"  ng-model="main_object.farm_id" class="form-control select2"  style="width: 100%;margin-right: 0px !important;" required>
                                    <option value="">Select</option>
                                     <option ng-repeat="list in farm_list" value="{{list.farm_id}}">{{list.farm_name}}</option>
                                </select>
                            </div>
                        </div>
                ...
                <table style="margin-top:55px;" class="table table-striped nomargin" ng-show="!mainPageSwitch">
                    ...
                    <tbody>
                     <tr ng-repeat="list in farm_payment">
                         ...
                         <td>
                             <button title="Edit" type="button" ng-click="edit_payment(list)" class="btn btn-default btn-xs"><i style="margin: 2px" class="fa fa-edit  "></i></button>
                             <button title="Delete" type="button" ng-click="delete_payment(list)" class="btn btn-default btn-xs"><i style="margin: 2px" class="fa fa-trash"></i></button>
                         </td>
                     </tr>
                    </tbody>
                </table>
