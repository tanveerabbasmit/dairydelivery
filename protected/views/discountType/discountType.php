...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/discountType/discountType-grid.js"></script>
...
<div id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">
    ...
    <div ng-controller="manageZone" ng-init='init(<?php echo $allow_delete ?>,<?php echo $zoneList ?>,  <?php echo $companyBranchList ?> ,"<?php echo Yii::app()->createAbsoluteUrl('DiscountType/saveNewZone'); ?>","<?php echo Yii::app()->createAbsoluteUrl('DiscountType/editZone'); ?>","<?php echo Yii::app()->createAbsoluteUrl('DiscountType/delete'); ?>","<?php echo Yii::app()->createAbsoluteUrl('DiscountType/saveRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('DiscountType/deleteRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('DiscountType/search'); ?>")'>
            ...
            <div style="margin-top:0px;" class="table-responsive">
                ...
                <table id="customers">
                    ...
                    <tr ng-repeat="zone in zoneList | filter:search:stric track by $index ">
                        ...
                        <td>
                            <span ng-show="!zone.update">{{zone.discount_type_name}}</span>
                            <span ng-show="zone.update" ><input style="width: 600px" class="form-control" type="text" ng-model="zone.discount_type_name"> </span>
                        </td>
                        <td>
