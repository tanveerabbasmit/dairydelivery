...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/ManageArea/ManageArea-grid.js"></script>
...
<div id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">
    ...
    ,"<?php echo Yii::app()->createAbsoluteUrl('Area/saveNewTagColor'); ?>","<?php echo Yii::app()->createAbsoluteUrl('Area/editZone'); ?>","<?php echo Yii::app()->createAbsoluteUrl('Area/delete'); ?>","<?php echo Yii::app()->createAbsoluteUrl('Area/saveRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('Area/deleteRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('Area/search'); ?>")'>
            ...
            <div style="margin-top:0px;" class="table-responsive">
                ...
                <table id="customers">
                    ...
                    <tr ng-repeat="zone in zoneList | filter:search:stric track by $index ">
                        ...
                        <td>
                            <span ng-show="!zone.update">{{zone.area_name}}</span>
                            <span ng-show="zone.update" ><input  class="form-control" type="text" ng-model="zone.area_name"> </span>
                        </td>
                        <td>
