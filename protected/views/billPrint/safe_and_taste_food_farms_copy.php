                            ...
                            <div style="width: 100% ;clear:both;" >
                                <div>
                                    <table   width="100%" border="1" cellpadding="3" id="customers" style="page-break-after:always ; border-collapse: collapse;" >
                                        ...
                                        <!--<tr>
                                            <th  colspan="3" style="text-decoration: none;color: black;border: 1px solid black;font-family: Arial, Helvetica;;font-size: 10px;">Arrears</th>
                                            <td colspan="3" style="font-family: Arial, Helvetica;border: 1px solid black ; text-align: right;font-size: 13px;" >{{mainList.arrearer |number :2}}</td>
                                            ...
                                            <td colspan="6" style="border: 1px solid white;direction: rtl;text-decoration: none;color: black;font-family: Arial, Helvetica;;font-size: 13px;">
                                                <div   style="width: 100%;">
                                                    ...
                                                    <div style="text-align: center">
                                                        <span style="margin-bottom : 1px;text-align: center; font-family: Arial">
                                                            <span style="font-weight: bold;direction: rtl">
                                                              یکم فروری 2021 سے دودھ کی قیمت 120 روپے فی لیٹر ہو گی۔
                                                            </span>
                                                        </span>
                                                    </div>
