		...
		<div id="printTable">
			...
			<div   class="col-lg-12 ridge" id="onepage" ng-repeat="mainList in finalOneObject">
				<div   style="page-break-after:always ; width: 100%;">
                        ...
                        <div> <p style="text-align: center;font-weight: bold;font-size:28px;">{{company_name}}</></div>
						<div style="width: 100% ;" >
						...
						<table   width="100%" border="1" cellpadding="3" id="customers" style="page-break-after:always ; border-collapse: collapse;" >
                               ...
                               <!-- <tr>
                                    <th  colspan="2" style="text-decoration: none;color: black;border: 1px solid black;font-family: Arial, Helvetica;;font-size: 10px;">Arrears</th>
                                    <td colspan="2" style="font-family: Arial, Helvetica;border: 1px solid black ; text-align: right;font-size: 10px;" >{{mainList.arrearer |number}}</td>
                                    <th colspan="2" style="text-decoration: none;color: black;border: 1px solid black;font-family: Arial, Helvetica;;font-size: 10px;">Collection</th>
                                    <td colspan="2" style="font-family: Arial, Helvetica;border: 1px solid black ; text-align: right;font-size: 10px;" >{{mainList.collection |number}}</td>
                                </tr>-->
								<tr>
