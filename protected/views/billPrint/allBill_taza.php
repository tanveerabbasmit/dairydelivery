        ...
        <div id="printTable">
            <div   class="col-lg-12 ridge" id="onepage" ng-repeat="mainList in finalOneObject">
                <div   style="page-break-after:always ; width: 100%;">
                    <div> <p style="line-height: 80%;text-align: center;font-weight: bold;font-size:20px;">{{company_name}} </></div>
                    <div> <p style="line-height: 80%;text-align: center; font-family: Arial">Please deposit online payment in this account. </p></div>
                    <div> <p style="line-height: 80%;text-align: center; font-family: Arial"> <span style="font-weight: bold"> Account Title:</span> (Siddiq Farms),<span style="font-weight: bold"> Bank: </span> Meezan Bank Limited,<span style="font-weight: bold">Account No:</span> (1160-0105633843)</p></div>
                    <div style="width: 100% ;" >
                        <div style="width: 100% ;" >
                                ...
                                <?php if($company_id !=4){ ?>
                                    <table style="background-color: white ;float: right" >
                                        ...
                                        <!--  <tr>
                                              ...
                                              <td colspan="5"><span  style="font-family: Arial, Helvetica;margin-left: 0px ;font-size: 12px;">Please deposit online.</span> </td>

                                          </tr>
                                         -->
                                        <!-- <tr>

                                             <td colspan="5"><span  style="font-family: Arial, Helvetica;margin-left: 0px ;font-size: 12px;"> payment in this account.</span> </td>

                                         </tr>-->
                                        <!-- <tr>

                                             <td colspan="2"><span  style="font-family: Arial, Helvetica;margin-left: 0px ;font-size: 12px;">Meezan Bank</span> </td>

                                         </tr>
                                         <tr>
                                             <td colspan="3" style="font-family: Arial, Helvetica;">Account Title:</td>
                                             <td colspan="2">Taza Farms</td>
                                         </tr>
                                         <tr>
                                             <td  colspan="3" style="font-family: Arial, Helvetica;">Branch Code :</td>
                                             <td  colspan="2">0248</td>
                                         </tr>
                                         <tr>
                                             <td  colspan="3" style="font-family: Arial, Helvetica;">Account No:</td>
                                             <td  colspan="2"> 0104003419</td>
                                         </tr>-->
                        ...
                        <div>
                            ...
                            <div style="width: 100% ;clear:both;" >
                                <div style="width: 100% ; ">
                                    <table style="background-color: white ;">
                                        <tr>
                                            <th style="font-family: Arial, Helvetica;text-align: right">Name:</th>
                                            <td><span  style="font-family: Arial, Helvetica;margin-left: 10px ;font-size: 12px;">{{mainList.clientObject.fullname}}({{mainList.clientObject.cell_no_1}})</span> </td>
                                            <th style="font-size: 10px;font-family: Arial, Helvetica;text-align: right">Address:</th>
                                            <td><span  style="font-size: 10px;font-family: Arial, Helvetica;margin-left: 10px">{{mainList.clientObject.address}}</span> </td>
                                        </tr>
                                        <tr>
                                            <th style="font-family: Arial, Helvetica;">Area:</th>
                                            <td>{{mainList.clientObject.zone_name}}</td>
                                            <!--<th style="font-family: Arial, Helvetica;">Security:</th>
                                            <td>{{mainList.clientObject.security}}</td>-->
                                        </tr>
                                ...
                                <div>
                                    ...
                                    <table   width="100%" border="1" cellpadding="3" id="customers" style="page-break-after:always ; border-collapse: collapse;" >
                                        ...
                                        <tr>
                                            <th colspan="8" style="color: black ;border: 1px solid black;font-family: Arial, Helvetica;font-size: 10px;text-decoration: none;"><a style="color: black ;" href="#">Product Summary</a> </th>
                                        </tr>
                                        <tr>
                                            <th style="border: 1px solid black"></th>
                                            <th colspan="3" style="text-decoration: none;border: 1px solid black;font-family: Arial, Helvetica;font-size: 10px;"><a style="color: black ;text-decoration: none;" href="#">Product</a></th>
                                            <th colspan="2" style="text-decoration: none;border: 1px solid black;font-family: Arial, Helvetica;font-size: 10px;"><a style="color: black ;text-decoration: none;" href="#">Quantity</a></th>
                                            <th colspan="2" style="text-decoration: none;border: 1px solid black;font-family: Arial, Helvetica;font-size: 10px;"><a style="color: black ;text-decoration: none;" href="#">Amount</a></th>
                                        </tr>

                                        <tr ng-repeat="summary in mainList.sumery">
                                            <td style="border: 1px solid black"></td>
                                            <td colspan="3" style=" border: 1px solid black;font-family: Arial, Helvetica;font-size: 10px;">{{summary.product_name }}</td>
                                            <td colspan="2" style="text-align:right ; border: 1px solid black;font-family: Arial, Helvetica;font-size: 10px;">{{summary.deliveryQuantity_sum | number :2}}</td>
                                            <td colspan="2" style="text-align: right ; border: 1px solid black;font-family: Arial, Helvetica;font-size: 10px;">{{summary.deliverySum |  number :2}}</td>
                                        </tr>
                                        <tr>
                                            <th colspan="4" style="text-decoration: none;color: black;border: 1px solid black;font-family: Arial, Helvetica;;font-size: 10px;">Current Month</th>
                                            <td colspan="4" style="font-family: Arial, Helvetica;border: 1px solid black ; text-align: right;font-size: 10px;" >{{mainList.sumery[0].deliverySum | number :2}}</td>
                                        </tr>
                                        <tr>
                                            <th  colspan="4" style="text-decoration: none;color: black;border: 1px solid black;font-family: Arial, Helvetica;;font-size: 10px;">Arrears</th>
                                            <td colspan="4" style="font-family: Arial, Helvetica;border: 1px solid black ; text-align: right;font-size: 10px;" >{{mainList.arrearer |number :2}}</td>

                                        </tr>
                                        <tr>
                                            <th colspan="4" style="text-decoration: none;color: black;border: 1px solid black;font-family: Arial, Helvetica;;font-size: 10px;">Collection/Advance</th>
                                            <td colspan="4" style="font-family: Arial, Helvetica;border: 1px solid black ; text-align: right;font-size: 10px;" >{{mainList.collection |number :2}}</td>
                                        </tr>

                                        <tr>
                                            <th colspan="4" style="text-decoration: none;color: black;border: 1px solid black;font-family: Arial, Helvetica;;font-size: 10px;">Total Discount</th>
                                            <td style="font-family: Arial, Helvetica;border: 1px solid black ; text-align: right;font-size: 10px;" colspan="4" >{{mainList.total_discount |number : 2}}</td>
                                        </tr>

                                        <tr>
                                            <th colspan="4" style="text-decoration: none;color: black;border: 1px solid black;font-family: Arial, Helvetica;;font-size: 10px;">Total payable</th>
                                            <td style="font-family: Arial, Helvetica;border: 1px solid black ; text-align: right;font-size: 10px;" colspan="4" >{{mainList.current_balance |number : 2}}</td>
                                        </tr>
                                        ...
                                        <?php if($company_id ==12){
                                            ...
                                            <tr style="border: 0px solid black;" ng-show="company_id ==12">
                                                <td style="border: 0px solid black;" colspan="3">
                                                    <div style=" ; float: left">
                                                        <img style="width: 60px ;height: 60px" src="<?php echo Yii::app()->theme->baseUrl; ?>/company_logo/frame.png" alt="" class="media-object ">
                                                        <P>Scan to download our mobile app</P>
                                                    </div>
                                                </td>
                                                <td style="border: 0px solid black;" colspan="4">
                                                    <div class="col-sm-5 ">
                                                        <p style="">
                                                            <span style="font-weight: bold;">Note :</span>
                                                            In case of any Complaint regarding quality, quantity and service, please contact us at 0300-8442237
                                                        </p>
                                                    </div>
                                                </td>
