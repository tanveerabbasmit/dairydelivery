...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/crudPosShop/crudPosShop-grid.js"></script>
...
<div id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">
    ...
    <div ng-controller="manageZone" ng-init='init(<?php echo $allow_delete ?>,<?php echo $zoneList ?>,  <?php echo $companyBranchList ?> ,"<?php echo Yii::app()->createAbsoluteUrl('PosShop/saveNewPosShop'); ?>","<?php echo Yii::app()->createAbsoluteUrl('PosShop/editZone'); ?>","<?php echo Yii::app()->createAbsoluteUrl('PosShop/delete'); ?>","<?php echo Yii::app()->createAbsoluteUrl('PosShop/saveRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('PosShop/deleteRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('PosShop/search'); ?>")'>
        ...
        <div class="" style="margin: 10px">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="<?php echo Yii::app()->baseUrl; ?>/PosStockReceived/stockTransfered">Stock Transfer To Shop</a></li>
                <li><a href="<?php echo Yii::app()->baseUrl; ?>/pos/pointOfSale">Stock Transfer To Shop</a></li>
            </ul>
            ...
            <div style="margin-top:0px;" class="table-responsive">
                ...
                <table id="customers">
                    ...
                    <tr style="background-color: #F0F8FF">
                        <th><a href="#">#</a></th>
                        <th><a href="#">Shop Name</a></th>
                        <th><a href="#">Address</a></th>
                        <th style="width: 200px"><a href="#">Action</a></th>
                   </tr>
                    </thead>
                    <tbody>
                    <tr ng-repeat="zone in zoneList | filter:search:stric track by $index ">
                        ...
                        <td >
                            <span ng-show="!zone.update">{{zone.shop_name}}</span>
                            <span ng-show="zone.update"><input type="text" ng-model="zone.shop_name" class="form-control" ></span>
                        </td>
                        <td >
                            <span ng-show="!zone.update">{{zone.address}}</span>
                            <span ng-show="zone.update"><input type="text" ng-model="zone.address" class="form-control" ></span>
                        </td>
                        ...
                        <td>
                            ...
                            <button ng-disabled="true ||         allow_delete[2]" ng-click="zoneDelete(zone)"  class="btn btn-sm btn-info next btn-xs" > <i class="fa fa-trash "></i></button>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3"></td>
                        <td>
                            <button ng-show="!zone.update"  ng-click="addnewZone(zone)"  class="btn btn-sm btn-default next " > <i class="fa fa-plus "></i> </button>
                        </td>
                    </tr>
