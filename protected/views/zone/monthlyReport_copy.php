...
<div class="row" id="testContainer" style="display: none ; background-color: white ;width: 3300px" ng-app="clintManagemaent" >
    <div ng-controller="clintManagemaent" ng-init='init(<?php echo json_encode($todayDate);  ?> ,<?php  echo $todayMonth  ?> ,<?php  echo $year  ?> , <?php echo $reportData  ?> , <?php echo $riderList ?> , "<?php echo Yii::app()->createAbsoluteUrl('zone/getOneMonthlyReport'); ?>")'>
       ...
       <br>
        ...
        <div style="margin:10px;"  class="col-lg-12">
                ...
                <div style="float: left;">
                  <select class="form-control input-sm" ng-model="riderId">
        ...
        <div style="margin:10px;">
            ...
            <table id="monthly_report">
                ...
                <tr ng-repeat="list in data track by $index">
                    ...
                    <td ><a ng-click href="">{{list.fullname}}</a> </td>
                    <td >{{list.address}}</td>
