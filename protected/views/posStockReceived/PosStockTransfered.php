...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/PosStockTransfered/PosStockTransfered-grid.js"></script>
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/FileSaver/FileSaver.js"></script>

<div  id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">
	<div ng-controller="riderDailyStockGridCtrl" ng-init='init(<?php echo $data;  ?> ,<?php echo $farmlist;  ?> ,<?php echo $company_id ?> , <?php echo $productList; ?>,"<?php echo Yii::app()->createAbsoluteUrl('PosStockReceived/PosSaveNewStock_add'); ?>"," <?php echo Yii::app()->createAbsoluteUrl('PosStockReceived/googleMap');?>" ," <?php echo Yii::app()->createAbsoluteUrl('PosStockReceived/saveDeliveryFromPortal');?>")'>
        ...
        <div class="tabbable">
			...
			<div class="tab-content">
				...
				<div class="tab-pane active" id="tab_1">
                    ...
                    <select style="width: 20%; float: left;margin-bottom: 10px;margin-left: 10px ; margin-right: 10px" class="form-control input-sm" ng-model="pos_shop_id" >
