...
<div class="container" ng-app="productGrid" ng-controller="manageProduct" ng-init='init(<?php echo $Amount  ?>)'>
       ...
       <div style="background-color: #9ab082;margin-top:1px;padding-top:10px;padding-bottom:10px;" class="row">
          <div  class="col-xs-6 col-sm-4" style="font-weight: bold;">Pay Amount:</div>
           <div  class="col-xs-6 col-sm-4" style="">
               <input style="background-color: #e1edd3; " class="form-control" type="text" name="pp_Amount" ng-model="amount" />
           </div>
        </div>
        ...
        <div style="background-color: #9ab082;margin-top:1px;padding-top:10px;padding-bottom:10px;" class="row">
            ...
            <div  class="col-xs-6 col-sm-4" >
                ...
                <select style="background-color: #e1edd3; " class="form-control" ng-model="pp_TxnType">
        ...
        <div class="col-sm-12" style="padding-left: 30% ; margin-top:20px" >
            ...
            <!--<input  style="width: 50%;background-color:#4a4a4a;color:white " type="submit" value="Confirm" class="btn btn-lg black btn-block">-->
             ...
             <a style="width: 50%;background-color:#4a4a4a;color:white "  class="btn btn-lg black btn-block" href="<?php echo Yii::app()->baseUrl; ?>/Milkhaas_payment/confirm_payment?client_id=<?php echo $client_id ?>&amount={{amount}}&outstanding_balance=<?php echo $outstanding_balance ?>&pp_TxnType={{pp_TxnType}}">Proceed</a>
