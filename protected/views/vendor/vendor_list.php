...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/vendor/vendor_grid.js"></script>
...
<div id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">
    ...
    <div ng-controller="manageZone" ng-init='init(<?php echo $vendor_type_list ?>,<?php echo $allow_delete ?>,<?php echo $zoneList ?>,  <?php echo $companyBranchList ?> ,"<?php echo Yii::app()->createAbsoluteUrl('vendor/save_vendor'); ?>","<?php echo Yii::app()->createAbsoluteUrl('vendor/edit_vendor'); ?>","<?php echo Yii::app()->createAbsoluteUrl('vendor/delete'); ?>","<?php echo Yii::app()->createAbsoluteUrl('vendor/saveRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('vendor/deleteRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('vendor/search'); ?>")'>
            ...
            <div style="margin-top:0px;" class="table-responsive">
                ...
                <table id="customers">
                    ...
                    <tr style="background-color: #F0F8FF">
                        ...
                        <th><a href="#">Provide Bill Alert</a></th>
                    ...
                    <tr ng-repeat="zone in zoneList | filter:search:stric track by $index ">
                        ...
                        <td>
                            <span ng-show="!zone.update">{{zone.vendor_name}}</span>
                            <span ng-show="zone.update" ><input  class="form-control" type="text" ng-model="zone.vendor_name" required> </span>
                        </td>
                        <td>
                            <span ng-show="!zone.update">{{zone.phone_no}}</span>
                            <span ng-show="zone.update" ><input placeholder="+923006053362" class="form-control" type="text" ng-model="zone.phone_no" required> </span>
                        </td>
                        <td>
                            <select ng-disabled="!zone.update" class="form-control" ng-model="zone.payment_alert">
                                <option value="1">active</option>
                                <option value="0">Inactive</option>
                            </select>
                        </td>
                        <td>
                            <select ng-disabled="!zone.update" class="form-control" ng-model="zone.provide_bill_alert">
                                <option value="1">active</option>
                                <option value="0">Inactive</option>
                            </select>
                        </td>
                        ...
                        <td>
                            <select ng-disabled="!zone.update" class="form-control" ng-model="zone.is_active">
                                <option value="1">active</option>
                                <option value="0">Inactive</option>
                            </select>
                        </td>
                        <td>
                            ...
                            <select ng-disabled="!zone.update" class="form-control" ng-model="zone.vendor_type_id">
                                <option value="0">Select Type </option>
                               <option value="{{list.vendor_type_id}}" ng-repeat="list in vendor_type_list">{{list.vendor_type_name}}</option>
                            </select>
                        </td>
