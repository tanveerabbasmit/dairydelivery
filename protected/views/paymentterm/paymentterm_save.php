...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/paymentterm/paymentterm_save_grid.js"></script>
            ...
            <div style="margin-top:0px;" class="table-responsive">
                ...
                <table id="customers">
                    ...
                    <tr ng-repeat="zone in zoneList | filter:search:stric track by $index ">
                        ...
                        <td>
                            <span ng-show="!zone.update">{{zone.payment_term_name}}</span>
                            <span ng-show="zone.update" ><input style="width: 600px" class="form-control" type="text" ng-model="zone.payment_term_name"> </span>
                        </td>
                        <td>
