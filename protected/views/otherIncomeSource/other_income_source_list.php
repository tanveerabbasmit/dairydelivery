...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/vendor/otherincome_source_grid.js"></script>
...
<div id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">
    ...
    <div ng-controller="manageZone" ng-init='init(<?php echo $allow_delete ?>,<?php echo $zoneList ?>,  <?php echo $companyBranchList ?> ,"<?php echo Yii::app()->createAbsoluteUrl('otherIncomeSource/save_income_source'); ?>","<?php echo Yii::app()->createAbsoluteUrl('otherIncomeSource/edit_vendor'); ?>","<?php echo Yii::app()->createAbsoluteUrl('otherIncomeSource/delete'); ?>","<?php echo Yii::app()->createAbsoluteUrl('otherIncomeSource/saveRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('otherIncomeSource/deleteRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('otherIncomeSource/search'); ?>")'>
            ...
            <div style="margin-top:0px;" class="table-responsive">
                ...
                <table id="customers">
                    ...
                    <tr ng-repeat="zone in zoneList | filter:search:stric track by $index ">
                        ...
                        <td>
                            <span ng-show="!zone.update">{{zone.other_income_source_name}}</span>
                            <span ng-show="zone.update" ><input  class="form-control" type="text" ng-model="zone.other_income_source_name" required> </span>
                        </td>
