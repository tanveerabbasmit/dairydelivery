...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/ProductSummary/customerWithRate-grid.js"></script>
...
<div id="testContainer" style="display: none" class="panel row" ng-app="productGrid">
    <div ng-controller="manageProduct" ng-init='init(<?php echo $get_data ?> ,<?php echo $today_date; ?>, <?php echo $productList ?> ,"<?php echo Yii::app()->createAbsoluteUrl('product/customerWithRate_list'); ?>")'>
