...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/product_purchase_summary/product_purchase_summary_report_view_all_grad.js"></script>
                   ...
                   <select style="width: 20%; float: left;margin-bottom: 10px;margin-left: 10px ; margin-right: 10px" class="form-control input-sm" ng-model="farm_id" >
                    ...
                    <table id="customers">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center" >{{total_result.total_net_quantity}}</td>
                            <td style="text-align: center">{{total_result.total_net_amount}}</td>
                            <td></td>
