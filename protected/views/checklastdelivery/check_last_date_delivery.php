...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/checklastdelivery/check_last_date_delivery_grid.js"></script>
...
<div  id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">
    <div ng-controller="riderDailyStockGridCtrl" ng-init='init(<?php echo "34" ?> , <?php echo "23" ?> , <?php echo json_encode([]); ?>,"<?php echo Yii::app()->createAbsoluteUrl('checklastdelivery/last_delivery_customer_list'); ?>"," <?php echo Yii::app()->createAbsoluteUrl('riderDailyStock/googleMap');?>" ," <?php echo Yii::app()->createAbsoluteUrl('riderDailyStock/saveDeliveryFromPortal');?>")'>
        <div class="tabbable">
                ...
                <div class=" active" id="tab_1" style="margin: 10px">
                    ...
                    <div class="col-md-12" style="margin-bottom: 10px">
                       ...
                       <!-- <select ng-model="paid_month" class="form-control input-sm" style="float: left ; width: 22% ;margin-left: 10px;margin-right: 10px">
                        ...
                        <button type="button" style="margin-left: 5px;float: left"  ng-click="selectRiderOnChange(selectRiderID)" class="btn btn-primary btn-sm"> <i class="fa fa-search" style="margin: 5px"></i> Search</button>

                        <img  style="margin: 5px" ng-show="imageLoading" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/loader-transparent.gif" alt="" class="loading">
