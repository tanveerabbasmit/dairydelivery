...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/manageClient/manageClient-grid.js"></script>
...
<div id="testContainer" style="display: none" class="panel row" ng-app="clintManagemaent">
    <div ng-controller="clintManagemaent" ng-init='init(<?php echo $product_list; ?>,<?php echo $sub_company_list ?>,<?php echo $customer_source_list ?>,<?php echo $payment_term_list ?>,<?php echo $rider_zone_object ?>, <?php echo $company_id;  ?> ,<?php echo str_replace("'","&#39;",$reasonList ); ?>,<?php echo str_replace("'","&#39;",$blockList ); ?>,<?php echo str_replace("'","&#39;",$areaList ); ?>, <?php echo $allow_delete ?> ,<?php echo str_replace("'","&#39;",$CategoryList ); ?> ,<?php echo $companyID ?> ,  <?php echo str_replace("'","&#39;",$ClientOneObject ); ?> , <?php  echo $preferedTimeList ?>  , <?php echo $frequencyList ?> , <?php echo $productCount  ?> , <?php echo $clientCount ?> , <?php echo str_replace("'","&#39;",$zoneList ); ?> ,<?php echo str_replace("'","&#39;",$clientList ); ?>,"<?php echo Yii::app()->createAbsoluteUrl('client/saveNewClient'); ?>"
	, "<?php echo Yii::app()->createAbsoluteUrl('client/EditClient'); ?>", "<?php echo Yii::app()->createAbsoluteUrl('client/delete'); ?>" , "<?php echo Yii::app()->createAbsoluteUrl('client/checkAlredyExistClient'); ?>", "<?php echo Yii::app()->createAbsoluteUrl('client/searchClient'); ?>",
	 "<?php echo Yii::app()->createAbsoluteUrl('client/nextPagePagination'); ?>", "<?php echo Yii::app()->createAbsoluteUrl('client/getProductList'); ?>"
	 , "<?php echo Yii::app()->createAbsoluteUrl('client/PnextPagePagination'); ?>", "<?php echo Yii::app()->createAbsoluteUrl('client/selectFrequencyForOrder'); ?>", "<?php echo Yii::app()->createAbsoluteUrl('client/saveChangedayObjectQuantity'); ?>", "<?php echo Yii::app()->createAbsoluteUrl('client/removeProductFormSchedual'); ?>", "<?php echo Yii::app()->createAbsoluteUrl('client/getProductPriceList'); ?>")'>
            ...
            <div style="margin-top:5px;" class="table-responsive" ng-show="mainPageSwitch">
                ...
                <table id="customers">
                    ...
                    <tr style="background-color: #F0F8FF">
                        <th><a href="#">ID</a></th>
                        <th>
                            <a ng-click="sort_function('fullname')" href="#">Name
                                <i ng-show="sort_object.fullname.sort_type=='2'" class="fa fa-sort-up"></i>
                                <i ng-show="sort_object.fullname.sort_type=='1'" class="fa fa-sort-down"></i>
                                <i ng-show="sort_object.fullname.sort_type=='0'" class="fa fa-sort" aria-hidden="true"></i>
                            </a>
                        </th>
                        ...
                        <th width="100px"><a href="#">Added By</a> </th>
                        <th width="100px"><a href="#">Created on</a> </th>
                        <th><a href="">Type</a> </th>
                        <th><a href="">Status</a> </th>
                        <!-- <th><a href=""></a> </th>-->
                        <!--  <th><a href="">View RP</a> </th>-->
                        <!--<th>Delete</th>-->
                    ...
                    <tr ng-repeat="clint in clientList">
                        ...
                        <td  ng-show="clint.is_active == '1'"  >
                            <a style="color: green" href="<?php echo Yii::app()->baseUrl; ?>/client/customerLedger/?client_id={{clint.client_id}}"> {{clint.fullname}}</a>
                        </td>
                        <td  ng-show="clint.is_active == '0'" >
                            <a style="color: darkred" href="<?php echo Yii::app()->baseUrl; ?>/client/customerLedger/?client_id={{clint.client_id}}"> {{clint.fullname}}</a>
                        </td>

                        <td>{{clint.address}}</td>
                        <td>
                            {{get_rider_name(clint.zone_id)}}
                        </td>

                        <span ng-show="clint.is_deleted == '0'" class="label label-primary">No</span>
                        <td>{{clint.zone_name}}</td>
                        <td>{{clint.cell_no_1}}</td>
                        <td>{{changeDateFormate(clint.LastTime_login)}}</td>


                        <td>
                            <img ng-show="clint.login_form==2" style="width: 10px ;height: 15px;color: green"   src="<?php echo Yii::app()->theme->baseUrl; ?>/images/Mobile_Icon.png" alt="" class="loading">
                            <img ng-show="clint.login_form==1" style="margin-left: 5px;width: 10px ;height: 10px"   src="<?php echo Yii::app()->theme->baseUrl; ?>/images/Laptop-2-icon.png" alt="" class="loading">
                            {{clint.user_name}}
                        </td>
                        <td>

                            {{clint.new_create_date}}
                        </td>


                        <td>
                            <span ng-show="clint.client_type == '1'" class="label label-default">Regular</span>
                            <span ng-show="clint.client_type == '2'" class="label label-primary">Sample</span>
                        </td>
                        ...
                        <!--<td>
                            <a ng-show="clint.recovery_report_view_or_hide== '1'"  ng-click="change_view_recovery_report(clint,0)" ng-click="" href=""> <span class="label label-info">View</span></a>
                            <a ng-show="clint.recovery_report_view_or_hide == '0'"  ng-click="change_view_recovery_report(clint ,1)" href="" > <span  class="label label-primary">Hide</span></a>
                        </td>-->

                        <!--<td>
                            <span ng-show="clint.is_deleted == '1'" class="label label-default">Deleted</span>
                        </td>-->
                        <!--<td>
                            <button title="Set Schedular"  ng-click="exchange_transfer(clint)" class="btn btn-default btn-xs"><i class="fa fa-exchange"></i></button>
                        </td>-->
                        <td width="150px">
                            <button title="Edit" type="button" ng-click="editClint(clint)" class="btn btn-default btn-xs"><i style="margin: 2px" class="fa fa-edit  "></i></button>
                            ...
                            <a target="_blank" title="Graph Schedule View" href="<?php echo  Yii::app()->createAbsoluteUrl('Schedule_view_graph/Schedule_view_graph_view') ?>/{{clint.client_id}}"   class="btn btn-default btn-xs"><i class="glyphicon glyphicon-calendar"></i></a>
                ...
                <tr ng-repeat="product in productList">
                    ...
                    <td style="width:50%;">
                        <ul class="table-options">
                            ...
                            <li>  <a  href="<?php echo Yii::app()->baseUrl; ?>/EffectiveDateSchedule/futureScheduled?client_id={{SelectClientID}}"  type="button"   class="btn btn-primary btn-sm"> <i class=""> <img style="" ng-show="true" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/icone/eye.png" alt="" class="loading"></a>

                            <li>  <a  href="<?php echo Yii::app()->baseUrl; ?>/SpecialOrder/createNewSpacialOrder?client_id={{SelectClientID}}&product_id={{product.product_id}}"  title="Special Order" type="button"   class="btn btn-primary btn-sm"><i style="font-size: 16px" class="fa fa-shopping-cart" aria-hidden="true"></i></a>


                            <li>  <a  target="_blank" href="<?php echo Yii::app()->baseUrl; ?>/halt_order/halt_order_create?client_id={{SelectClientID}}&product_id={{product.product_id}}"  type="button"><span style="padding: 5px;font-weight: bold;">Halt</span> </a>
        ...
        <modal title="Add Customer" visible="showAddNewClient">
            <form role="form" class="form-group" ng-submit="saveClient(ClientObject)">
                ...
                <div class="col-lg-12 form-group" style="background-color: #FFF0F5">
                    <div class="col-lg-4" style="padding: 10px">
                        <span style="font-weight: bold;font-size: 13px;">First Name <span class="required" style="color: red">*</span> :</span>
                    </div>
                    <div class="col-lg-8">
                        ...
                        <span ng-show="checkAlredyFullNameExist" style="color: green">This Full Name is already exist </span>
                    </div>
                </div>
                ...
                <div class="col-lg-12 form-group" style="background-color: #FFF0F5">
                    <div class="col-lg-4" style="padding: 10px">
                        <span style="font-weight: bold;font-size: 13px;">Last Name <span class="required" style="color: red"></span> :</span>
                    </div>
                    <div class="col-lg-8">
                        <input type="text"  ng-model="ClientObject.last_name"  class="form-control" />
                        <span ng-show="checkAlredyFullNameExist" style="color: green">This Full Name is already exist </span>
                    </div>
                </div>
                ...
                <div class="col-lg-12 form-group"  style="background-color: 	#FFF0F5">
                    ...
                    <div class="col-lg-8">
                        ...
                        <select ng-model="ClientObject.customer_category_id"  class="form-control" required>
                ...
                <div class="col-lg-12 form-group" >
                    <div class="col-lg-4" style="padding: 10px">
                        ...
                        <span class="required" style="color: red">*</span>: </span>
                    </div>
                    <div class="col-lg-8">


                        <select class="form-control" ng-model="ClientObject.payment_term" required>
                ...
                <div id="more_view" class="col-lg-12" style="margin-bottom: 15px">
                    <div class="col-lg-12" style="margin-bottom: 10px">
                        <div  class="col-lg-4" >
                            <button type="button" class="btn btn-default" data-toggle="collapse" data-target="#demo">View More Field </button>
                        </div>
                        <div  class="col-lg-4" >
                            <button ng-click="showDayScheduleok_for_new_cutomer()" type="button" class="btn btn-info"  >Add Schedule</button>
                        </div>

                        <div  class="col-lg-4" >
                            <button ng-click="showDayScheduleok_spacial_order_for_new_cutomer()" type="button" class="btn btn-info"  >Add Special Order</button>
                        </div>
                    </div>
                    ...
                    <div id="demo" class="collapse">
                        ...
                        <div class="col-lg-12 form-group" >
                            ...
                            <div class="col-lg-8">
                                <input ng-change="make_full_name_function()" type="text" ng-model="ClientObject.house_no" class="form-control"   />
                            </div>
                        </div>

                        <div class="col-lg-12 form-group" >
                            <div class="col-lg-4" style="padding: 10px">
                                <span style="font-weight: bold;font-size: 13px; padding: 8px">Sub No./Street No.  :</span>
                            </div>
                            <div class="col-lg-8">
                                <input ng-change="make_full_name_function()" type="text" ng-model="ClientObject.sub_no" class="form-control"   />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 form-group"  style="background-color: 	#FFF0F5">
                            ...
                            <div class="col-lg-8">
                                <select ng-change="make_full_name_function()" ng-model="ClientObject.block_id"  class="form-control" >
                        ...
                        <div class="col-lg-12 form-group"  style="background-color: 	#FFF0F5">
                            ...
                            <div class="col-lg-8">
                                <select ng-change="make_full_name_function()" ng-model="ClientObject.area_id"  class="form-control" >
                        ...
                        <div class="col-lg-12 form-group"  style="background-color: 	#FFF0F5">
                            <div class="col-lg-4" style="padding: 10px">
                                <span style="font-weight: bold;font-size: 13px; padding: 8px">Security Type Customer<span class="required" style="color: red">*</span>: </span>
                            </div>

                            <div class="col-lg-8">
                                <select ng-model="ClientObject.security_type_customer"  class="form-control" required>
                                    <option value="0">Nothing</option>
                                    <option value="1">Security Deposit</option>
                                    <option value="2">Cridit Limit</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 form-group"  style="">
                            <div class="col-lg-4" style="padding: 10px">
                                <span style="font-weight: bold;font-size: 13px; padding: 8px">Gross Ammount : </span>
                            </div>
                            <div class="col-lg-8">
                                <input type="text" ng-model="ClientObject.grass_amount" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 form-group" >
                            <div class="col-lg-4" style="padding: 10px">
                                <span style="font-weight: bold;font-size: 13px; padding: 8px">Source  Master:</span>
                            </div>
                            <div class="col-lg-8">

                                <select class="form-control" ng-model="ClientObject.customer_source_id">
                                    <option value="0">Select</option>
                                    <option ng-repeat="list in customer_source_list" value="{{list.customer_source_id}}">{{list.customer_source_name}}</option>
                                </select>
                        ...
                        <div class="col-lg-12 form-group">
                            ...
                            <div class="col-lg-4" style="padding: 10px">
                                <span style="font-weight: bold;font-size: 13px; padding: 8px">Customer Source :</span>
                            </div>

                            <div class="col-lg-8">
                                <input ng-change="change_source()" class="form-control" list="browsers" name="browser" ng-model="ClientObject.customer_source_name">

                                <datalist id="browsers">
                                    <option value="{{list.name}}" ng-repeat="list in search_cutomer_list">
                        ...
                        <div class="col-lg-12 form-group" style="background-color: honeydew">
                            <div class="col-lg-4" style="padding: 10px">
                                <span style="font-weight: bold;font-size: 13px; padding: 8px">Receipt Alert :</span>
                            </div>

                            <div class="col-lg-8">
                                <label class="radio-inline">
                                    <input ng-model="ClientObject.receipt_alert"   type="radio" name="receipt_alert" value="1" required>
                                    <span  class="label label-default">Active</span>
                                </label>
                                <label class="radio-inline">
                                    <input ng-model="ClientObject.receipt_alert" type="radio" name="receipt_alert" value="0" required>
                                    <span  class="label label-primary">Inactive</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 form-group" style="background-color: honeydew">
                            <div class="col-lg-4" style="padding: 10px">
                                <span style="font-weight: bold;font-size: 13px; padding: 8px">Notification  Allow:</span>
                            </div>
                            <div class="col-lg-8">
                                <label class="radio-inline">
                                    <input ng-model="ClientObject.notification_alert_allow_user"   type="radio" name="notification_alert_allow_user" value="1" required>
                                    <span  class="label label-default">Yes</span>
                                </label>
                                <label class="radio-inline">
                                    <input ng-model="ClientObject.notification_alert_allow_user" type="radio" name="notification_alert_allow_user" value="0" required>
                        ...
                        <div class="col-lg-12 form-group" style="background-color: honeydew">
                            <div class="col-lg-4" style="padding: 10px">
                                <span style="font-weight: bold;font-size: 13px; padding: 8px">One Time Delivery</span>
                            </div>
                            <div class="col-lg-8">
                                <label class="radio-inline">
                                    <input ng-model="ClientObject.one_time_delivery"   type="radio" name="one_time_delivery" value="1" required>
                                    <span  class="label label-default">Yes</span>
                                </label>
                                <label class="radio-inline">
                                    <input ng-model="ClientObject.one_time_delivery" type="radio" name="one_time_delivery" value="0" required>
                                    <span  class="label label-primary">No</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 form-group">
                            <div class="col-lg-4" style="padding: 10px">
                                <span style="font-weight: bold;font-size: 13px; padding: 8px">Discount:</span>
                            </div>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" ng-change="change_discount_amount(rate_discount_amount)" ng-model="rate_discount_amount">
                            </div>
                        </div>
                ...
                <div class=" form-group ">
                    ...
                    <button ng-disabled="allow_delete =='0' || checkAlredyExist ||saveClientButtonDisabled"  type="submit" class="btn-success  btn-sm">Save</button>
        ...
        <modal title="Cutomer Transfer" visible="cutomer_transfer">


            <form role="form" class="form-group" ng-submit="transfer_customer_function(selected_client_object,selected_company_id)">
                <p class="note">Customer Transfer to other Company</p>
                <p class="note">Selected Customer : <span style="color: green">{{selected_client_object.fullname}}</span></p>



                <div class="col-lg-12 form-group" style="background-color: #FFF0F5">
                    <div class="col-lg-4" style="padding: 10px">
                        <span style="font-weight: bold;font-size: 13px;">Transfer to <span class="required" style="color: red">*</span> :</span>
                    </div>
                    <div class="col-lg-8">
                        <select class="form-control" ng-model="selected_company_id" required>
                            <option value="">Select</option>
                            <option ng-repeat="list in sub_company_list" value="{{list.company_id}}">{{list.company_name}}</option>
                        </select>
                ...
                <div class="col-lg-12 form-group" style="height: 10px"></div>
                <div class=" form-group ">
                    <button   type="submit" class="btn-success  btn-sm">Transfer</button>
                </div>
            </form>
        </modal>
        ...
        <modal title="Update Customer" visible="showEditClient">
            ...
            <form role="form" class="form-group" ng-submit="editClientFunction(ClientObject)">
                <p class="note">Fields with <span class="required" style="color: red">*</span> are required.</p>
                <p ng-show="ClientObject.deactive_reason!='' && ClientObject.is_active =='0' " class="note" style="color: darkolivegreen">Drop Reason : {{ClientObject.deactive_reason}} </p>
                ...
                <div id="more_view" class="col-lg-12" style="margin-bottom: 15px">
                    ...
                    <button type="button" class="btn btn-default" data-toggle="collapse" data-target="#demo_2">
                        View More Field
                    </button>
                    <div id="demo_2" class="collapse">
                        ...
                        <div class="col-lg-12 form-group" >
                            <div class="col-lg-4" style="padding: 10px">
                                <span style="font-weight: bold;font-size: 13px; padding: 8px">Sub No./Street No 1. :</span>
                            </div>
                            <div class="col-lg-8">
                                <input ng-change="make_full_name_function()" type="text" ng-model="ClientObject.sub_no" class="form-control"   />
                            </div>
                        ...
                        <div class="col-lg-12 form-group"  style="background-color: 	#FFF0F5">
                            ...
                            <div class="col-lg-8">
                                <select ng-change="make_full_name_function()" id="block" ng-model="ClientObject.block_id"  class="form-control" >
                                    <option value="">Select Block</option>
                                    <option ng-repeat="zone in blockList" value="{{zone.block_id}}">{{zone.block_name}}</option>
                                </select>
                            </div>
                        ...
                        <div class="col-lg-12 form-group" >
                            <div class="col-lg-4" style="padding: 10px">
                                <span style="font-weight: bold;font-size: 13px; padding: 8px">Customer Master :</span>
                            </div>

                            <div class="col-lg-8">

                                <select autocomplete="off" class="form-control" ng-model="ClientObject.customer_source_id">
                                    <option value="0">Select</option>
                                    <option ng-repeat="list in customer_source_list" value="{{list.customer_source_id}}">{{list.customer_source_name}}</option>
                                </select>
                        ...
                        <div class="col-lg-12 form-group">
                            ...
                            <div class="col-lg-8">
                                <input autocomplete="off" ng-change="change_source()" class="form-control" list="browsers" name="browser" ng-model="ClientObject.customer_source_name">
                                <datalist id="browsers">
                                    <option value="{{list.name}}" ng-repeat="list in search_cutomer_list">
                                </datalist>
                            </div>
                        ...
                        <!-- <div class="col-lg-12 form-group" style="background-color: honeydew">
                             <div class="col-lg-4" style="padding: 10px">
                                 <span style="font-weight: bold;font-size: 13px; padding: 8px">Notification Channel:</span>
                             </div>
                             <div class="col-lg-8">
                                 <label class="checkbox-inline">
                                     <input ng-model="ClientObject.is_mobile_notification" type="checkbox" value="">Mobile Notification
                                 </label>
                                 <label class="checkbox-inline">
                                     <input ng-model="ClientObject.is_push_notification" type="checkbox" value="">Push Notification
                                 </label>
                             </div>
                         </div>-->
                        ...
                        <div class="col-lg-12 form-group">
                            <div class="col-lg-4" style="padding: 10px">
                                <span style="font-weight: bold;font-size: 13px; padding: 8px">Product Price: 2</span>
                            </div>
                            <div class="col-lg-8">
                        ...
                        <div class="col-lg-12 form-group">
                          ...
                          <?php
                             ...
                             if($user_object['supper_admin_user']==1 and $company_id ==1){
        ...
        <modal title="Interval schedule" visible="showDaySchedule_interval">
            ...
            <form ng-submit="clientProductScheduleChangeSave_interval(intervalScheduleObject)">
                ...
                <div class="col-lg-12" style="margin-bottom: 10px;background-color: #FFF0F5">
                    <div class="col-lg-5" style="padding-top: 10px">
                        <span style="font-weight: bold;font-size: 13px; padding: 8px;">Delivery on Alternate Day </span>
                    </div>
                    <div class="col-lg-7">
                        <input type="text"    class="form-control" ng-model="intervalScheduleObject.default_value" required>
                        <div class="help-block" style="color: #008000">Pick this default value  when deliver is off  </div>
                    </div>
                </div>
        ...
        <!-- start: show Schedule See-->
        <modal title="weekly schedule New Customer " visible="showDaySchedule_new_customer">
            <span ng-show="false">{{changeStartOrderDate(orderStartDate)}}</span>

            <div class="col-lg-12" style="margin-bottom: 10px">

                <div class="col-lg-6">
                    <span style="font-weight: bold;font-size: 13px; padding: 8px">Product : </span>
                </div>
                ...
                <div class="col-lg-6">
                    <span style="">
                            ...
                            <select id="product_id_new" class="form-control" ng-model="product_id_new">
            ...
            <button type="button" class="btn btn-sm btn-info btn-xs" title="Close"  ng-click="showDayScheduleok_for_new_cutomer()"> OK</button>
            <!--<button ng-disabled="allow_delete[3]" ng-click="clientProductScheduleChangeSave2(frequencyList , orderStartDate)" type="button" class="btn btn-primary btn-xs"><i class="fa fa-save"></i> Save</button>-->
        </modal>
        <!-- end: show Schedule See -->
        ...
        <modal title="Spacial Order" visible="show_spacial_order_new_customer">
            <span ng-show="false">{{changeStartOrderDate(orderStartDate)}}</span>

            <div class="col-lg-12" style="background-color: #FFF0F5;margin-bottom: 10px">

                <div class="col-lg-4" >
                    <span style="font-weight: bold;font-size: 13px; padding: 8px">Product <span class="required" style="color: red">*</span> : </span>
                </div>
                ...
                <div class="col-lg-8">
                    <span style="">
                            ...
                            <select id="product_id_new" class="form-control" ng-model="spacial_order_object.product_id">
                                    <option value="0">Select Product</option>
                                    <option value="{{list.product_id}}" ng-repeat="list in product_list">{{list.name}}</option>
                            </select>
                    </span>
            ...
            <div class="col-lg-12 form-group" style="background-color: #FFF0F5">
                <div class="col-lg-4" style="padding: 10px">
                    <span style="font-weight: bold;font-size: 13px;">Sart Date <span class="required" style="color: red">*</span> :</span>
                </div>
                <div class="col-lg-8">

                    <input class="form-control" datetime-picker="" date-only="" date-format="yyyy-MM-dd" type="text" required="" ng-model="spacial_order_object.startDate" size="2">
                </div>
            </div>

            <div class="col-lg-12 form-group" style="background-color: #FFF0F5">
                <div class="col-lg-4" style="padding: 10px">
                    <span style="font-weight: bold;font-size: 13px;">End Date <span class="required" style="color: red">*</span> :</span>
                </div>
                <div class="col-lg-8">

                    <input class="form-control" datetime-picker="" date-only="" date-format="yyyy-MM-dd" type="text" required="" ng-model="spacial_order_object.endDate" size="2">
                </div>
            </div>

            <div class="col-lg-12 form-group" style="background-color: #FFF0F5">
                <div class="col-lg-4" style="padding: 10px">
                    <span style="font-weight: bold;font-size: 13px;">Quantity <span class="required" style="color: red">*</span> :</span>
                </div>
                <div class="col-lg-8">

                    <input class="form-control"  type="text" required="" ng-model="spacial_order_object.quantity" size="2">
                </div>
            </div>

            <button type="button" class="btn btn-sm btn-info btn-xs" title="Close"  ng-click="showDayScheduleok_spacial_order_for_new_cutomer()"> OK</button>
            <!--<button ng-disabled="allow_delete[3]" ng-click="clientProductScheduleChangeSave2(frequencyList , orderStartDate)" type="button" class="btn btn-primary btn-xs"><i class="fa fa-save"></i> Save</button>-->
        </modal>
