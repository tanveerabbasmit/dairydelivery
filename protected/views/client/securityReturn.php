...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/makePayment/securityReturn-grid.js"></script>
			...
			<form ng-submit="savePaymernt()">
				<div class="col-lg-12">
                    ...
                    <div class="col-lg-6" style="background-color: honeydew">
                        ...
                        <div class="col-lg-8">
                            <input  class="form-control"    datetime-picker date-only  date-format="yyyy-MM-dd" type="text" required ng-model="startDate" size="2">
                        </div>
                    </div>
				</div>
                <div class="panel-body">
                ...
                <div class="col-lg-12">
                    <div class="col-lg-6" style="background-color: honeydew">
                        ...
                        <div class="col-lg-8">
                            <input  class="form-control"     type="number" required ng-model="security_amount" size="2">
                        </div>
