...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/deleteClient/deleteClient-grid.js"></script>
...
<div id="testContainer" style="display: none" class="panel row" ng-app="clintManagemaent">
	<div ng-controller="clintManagemaent" ng-init='init(<?php echo $companyID ?> ,  <?php echo  $ClientOneObject; ?> , <?php  echo $preferedTimeList ?>  , <?php echo $frequencyList ?> , <?php echo $productCount  ?> , <?php echo $clientCount ?> , <?php echo $zoneList; ?> ,<?php echo $clientList; ?>,"<?php echo Yii::app()->createAbsoluteUrl('client/saveNewClient'); ?>"
	, "<?php echo Yii::app()->createAbsoluteUrl('client/EditClient'); ?>", "<?php echo Yii::app()->createAbsoluteUrl('client/delete'); ?>" , "<?php echo Yii::app()->createAbsoluteUrl('client/checkAlredyExistClient'); ?>", "<?php echo Yii::app()->createAbsoluteUrl('client/searchClient'); ?>",
	 ...
	 , "<?php echo Yii::app()->createAbsoluteUrl('client/PnextPagePagination'); ?>", "<?php echo Yii::app()->createAbsoluteUrl('client/selectFrequencyForOrder'); ?>", "<?php echo Yii::app()->createAbsoluteUrl('client/saveChangedayObjectQuantity'); ?>", "<?php echo Yii::app()->createAbsoluteUrl('client/removeProductFormSchedual'); ?>", "<?php echo Yii::app()->createAbsoluteUrl('client/getProductPriceList'); ?>")'>
		...
		<div class="" style="margin: 10px">
			<div class="row" ng-show="mainPageSwitch">
				<div class="col-lg-3">
						...
						<button type="button"  ng-click="addNewClient()" class="btn btn-primary btn-sm"> <i class="fa fa-plus"></i> Add New Customer</button>
		        		...
		        		<tr ng-repeat="clint in clientList">
							...
							<td>
								<ul class="table-options ">
									...
									<li><a href=""   ng-click="deleteClientButton(clint)"><i class="fa fa-trash btn btn-info btn-md"></i></a></li>
		...
		<modal title="Add New Customer" visible="showAddNewClient">
			<form role="form" class="form-group" ng-submit="saveClient(ClientObject)">
				...
				<div class="col-lg-12 form-group" style="background-color: 	#FFF0F5">
					<div class="col-lg-4" style="padding: 10px">
						<span style="font-weight: bold;font-size: 13px; padding: 8px">Date of birth <span class="required" style="color: red">*</span> :</span>
					</div>
					<div class="col-lg-8">
				...
				<tr ng-repeat="product in productList">
					...
					<td>
						<ul class="table-options">
							...
							<li ng-show="product.ObjectOFDayWiseQuantity"> <button  ng-click="clientProductScheduleChangeSave(product)" type="button" class="btn btn-primary btn-xs"><i class="fa fa-save"></i> Save</button></li>
		...
		<modal title="weekly schedule" visible="showDaySchedule">
			...
			<button type="button" class="btn btn-sm btn-info prev" title="Prev"  ng-click="showDayScheduleok()"> OK </button>
			<button  ng-click="clientProductScheduleChangeSave2(frequencyList , orderStartDate)" type="button" class="btn btn-primary btn-xs"><i class="fa fa-save"></i> Save</button>
		</modal>
		<!-- end: show Schedule See -->
		...
		<modal title="Interval schedule" visible="showDaySchedule_interval">
			<span ng-show="false">{{changeStartOrderDate(orderStartDate)}}</span>
              <form ng-submit="clientProductScheduleChangeSave_interval(intervalScheduleObject)">
				...
				<button type="button" class="btn btn-sm btn-info prev" title=""  ng-click="showDayScheduleok_interval()"> OK </button>
				<button   title="" ng-click="" type="submit" class="btn btn-primary btn-xs"><i class="fa fa-save"></i> Update</button>
			</form>
		</modal>
