...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/mangeSaleReps/mangeSaleReps-grid.js"></script>
...
<div id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">
    ...
    <div ng-controller="manageZone" ng-init='init(<?php echo $allow_delete ?>,<?php echo $zoneList ?>,  <?php echo $companyBranchList ?> ,"<?php echo Yii::app()->createAbsoluteUrl('SalesReps/saveNewSalesReps'); ?>","<?php echo Yii::app()->createAbsoluteUrl('SalesReps/editZone'); ?>","<?php echo Yii::app()->createAbsoluteUrl('SalesReps/delete'); ?>","<?php echo Yii::app()->createAbsoluteUrl('SalesReps/saveRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('SalesReps/deleteRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('SalesReps/search'); ?>")'>
            ...
            <div style="margin-top:0px;" class="table-responsive">
                ...
                <table id="customers">
                    ...
                    <tr ng-repeat="zone in zoneList | filter:search:stric track by $index ">
                        ...
                        <td>
                            <span ng-show="!zone.update">{{zone.name}}</span>
                            <span ng-show="zone.update" ><input  class="form-control" type="text" ng-model="zone.name"> </span>
                        </td>
                        <td>
                            <span ng-show="!zone.update">{{zone.phone}}</span>
                            <span ng-show="zone.update" ><input  class="form-control" type="text" ng-model="zone.phone"> </span>
                        </td>

                        <td>
                            <span ng-show="!zone.update">{{zone.email}}</span>
                            <span ng-show="zone.update" ><input  class="form-control" type="text" ng-model="zone.email"> </span>
                        </td>

                        <td>
                            <span ng-show="!zone.update">{{zone.address}}</span>
                            <span ng-show="zone.update" ><input  class="form-control" type="text" ng-model="zone.address"> </span>
                        </td>
                        <td>
