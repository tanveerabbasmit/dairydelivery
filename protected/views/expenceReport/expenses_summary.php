...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/addExpence/expenses_summary_grid.js"></script>
...
<div  id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">
	<div ng-controller="riderDailyStockGridCtrl" ng-init='init(<?php echo $data ?> ,"<?php echo Yii::app()->createAbsoluteUrl('ExpenceReport/base'); ?>")'>
			<div class="tabbable">
                   ...
                   <!-- <div class="dropdown" style="f ;margin-left: 5px">
					...
					<table id="customers">
						...
						<tr ng-repeat="list in list_data">
                            <td ><span ng-bind="list.type"></span> </td >
                            <td style="text-align: right"><span ng-bind="list.total_amount"></span> </td >
						</tr>
                        <tr>
                            <td >Total</td>
                            <td style="text-align: right"><span ng-bind="grand_total_amount"></span></td>
