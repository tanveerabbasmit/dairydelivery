<div class=" container">
    ...
    <form action="<?= $paymentUrl ?>" method="post" target="_parent" onsubmit="return submitForm(this)">
        ...
        <div class="row" style="margin-bottom: 1em;">
            ...
            <div class="col-xs-7"><?= 1 == $paymentMethod ? 'Alpha Wallet' : 'Alpha Account' ?></div>
        </div>
        ...
        <div style="padding-top: 2em; text-align: center; color: white">
            Powered by: <img src="<?= Yii::app()->theme->baseUrl . '/images/gateway-alphapay.png' ?>" alt="jazzcash" style="width:48px;height:48px;border-radius:50%" />
        </div>
