...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/farm/farms_payasble_summary_grd.js"></script>
...
<div  id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">
	<div ng-controller="riderDailyStockGridCtrl" ng-init='init(<?php echo $data ?> ,"<?php echo Yii::app()->createAbsoluteUrl('Farm/base'); ?>")'>
			<div class="tabbable">
                  ...
                  <!--  <select ng-model="vendor_id" class="form-control input-sm" style="float: left ; width: 17% ;margin-left: 10px;margin-right: 10px">
                    ...
                    <div class="dropdown" style="f ;margin-left: 5px">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo Yii::app()->baseUrl; ?>/farm/farms_payasble_summary_export?startDate={{startDate}}&endDate={{endDate}}&vendor_id={{vendor_id}}">Export CSV</a></li>
                        </ul>
                    </div>
					...
					<table id="customers">
						...
						<tr ng-repeat="list in list_data.data">
							...
							<td><span ng-bind="list.opening_stock  | number"></span> </td >
							<td><span ng-bind="list.purchse_date_range  | number"></span> </td >
							<td><span ng-bind="list.payment_date_range  | number"></span> </td >
							<td><span ng-bind="list.balance  | number"></span> </td >
