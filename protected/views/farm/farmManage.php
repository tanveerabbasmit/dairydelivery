...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/farm/farm-grid.js"></script>
    ...
    <div ng-controller="manageZone" ng-init='init(<?php echo $allow_delete ?>,<?php echo $zoneList ?>,  <?php echo $companyBranchList ?> ,"<?php echo Yii::app()->createAbsoluteUrl('farm/saveNewZone'); ?>","<?php echo Yii::app()->createAbsoluteUrl('farm/editquality'); ?>","<?php echo Yii::app()->createAbsoluteUrl('farm/delete'); ?>","<?php echo Yii::app()->createAbsoluteUrl('riderDailyStock/saveRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('riderDailyStock/deleteRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('riderDailyStock/search'); ?>")'>
        <ul class="nav nav-tabs nav-tabs-lg">
            ...
            <!--<li style="margin-left: 2px">
                <a  href="<?php /*echo Yii::app()->baseUrl; */?>/FarmQuality/qualityValue"  type="button"   class="btn btn-primary btn-sm"> <i class=""></i>
                    Add  Quality
                </a>
            </li>
        ...
        <div class="" style="margin: 10px">
            ...
            <ul class="breadcrumb">
                <li><a href="<?php echo Yii::app()->baseUrl; ?>/qualityList/qualityListManage">Quality</a></li>
                <li><a href="<?php echo Yii::app()->baseUrl; ?>/FarmQuality/qualityValue">Add  Quality</a></li>
                <li><a href="<?php echo Yii::app()->baseUrl; ?>/FarmQuality/valueList">Quality Report</a></li>
            </ul>
            ...
            <div style="margin-top:0px;" class="table-responsive">
                ...
                <table id="customers">
                    ...
                    <tr style="background-color: #F0F8FF">
                        <th><a href="#">#</a></th>
                        <th width="20%"><a href="#">Name</a></th>
                        <th width="20%"  style="text-align: center"><a href="#">Phone No.</a></th>
                        <th  width="20%"  style="text-align: center"><a href="#">Purchase Alert</a></th>
                        <th  width="20%"  style="text-align: center"><a href="#">Payment Alert</a></th>
                        <th  width="20%"  style="text-align: center"><a href="#">Status</a></th>
                    ...
                    <tr ng-repeat="zone in zoneList | filter:search:stric track by $index ">
                        ...
                        <td>
                            <span ng-show="!zone.update">{{zone.farm_name}}</span>
                            <span ng-show="zone.update"><input type="text" ng-model="zone.farm_name" class="form-control"> </span>
                        </td>

                        <td>
                            <span ng-show="!zone.update">{{zone.phone_number}}</span>
                            <span ng-show="zone.update"><input placeholder="+923006053362" type="text" ng-model="zone.phone_number" class="form-control"> </span>
                        </td>
                        <td>
                        ...
                        <td>
                            <select ng-disabled="!zone.update" class="form-control" ng-model="zone.purchase_alert">
                                <option value="1">Active</option>
                                <option value="0">Inactive</option>
                            </select>
                        </td>
