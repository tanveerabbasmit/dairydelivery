...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/viewcompanystock/stock_in_detail_grad.js"></script>
...
<div class="" id="testContainer" style="display: none" ng-app="clintManagemaent"ng-controller="clintManagemaent" ng-init='init( <?php echo json_encode($data) ?> , "<?php echo Yii::app()->createAbsoluteUrl('Mobiledesign/stock_summary_list'); ?>")'>
    ...
    <div class="col-lg-12" style="text-align: center;">
         <h3 style="color: darkolivegreen">Stock In Detail</h3>
    </div>
    ...
    <div class="col-lg-12 " style="">
        ...
        <div class="col-sm-3 form-group" style="height: 10px">
            ...
            <img style="margin-top: 5px" ng-show="reportLoader"  src="<?php echo Yii::app()->theme->baseUrl; ?>/images/loading.gif" alt="" class="loading">
        </div>
    ...
    <table class="table table-bordered" style="margin-top: 15px">
        ...
        <tr>
            ...
            <th style=" text-align: center; vertical-align: middle;">Total Purchase</th>
            <th style=" text-align: center; vertical-align: middle;">Farm </th>
            <th style=" text-align: center; vertical-align: middle;">Purchase</th>
