...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/manageExpenceType/manageExpenceType-grid.js"></script>
...
<?php $allow_delete = crudRole::getCrudrole(41); ?>

<div id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">

    <div ng-controller="manageZone" ng-init='init(<?php echo $allow_delete ?>, <?php echo  str_replace("'","/",$zoneList);  ?>,  <?php echo str_replace("'","/",$companyBranchList);  ?> ,"<?php echo Yii::app()->createAbsoluteUrl('expenceType/saveNewExpence'); ?>","<?php echo Yii::app()->createAbsoluteUrl('expenceType/editZone'); ?>","<?php echo Yii::app()->createAbsoluteUrl('expenceType/delete'); ?>","<?php echo Yii::app()->createAbsoluteUrl('expenceType/saveRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('expenceType/deleteRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('expenceType/search'); ?>")'>
        ...
        <div class="" style="margin: 10px">
             <div class="">
                ...
                <div class="col-lg-4">
                    <div >
                        <button ng-disabled="allow_delete[1]" type="button"  ng-click="addnewZone()" class="btn btn-primary btn-sm"> <i class="fa fa-plus"></i> Add New Expense</button>
                ...
                <table id="customers">
                    ...
                    <tr ng-repeat="zone in zoneList | filter:search:stric track by $index ">
                        ...
                        <td  >
                            ...
                            <button ng-disabled=" allow_delete[2]" href="" ng-click="zoneDelete(zone)" class="btn btn-sm btn-info next btn-xs" > <i class="fa fa-trash "></i></button>
        ...
        <modal title="Add New Expense" visible="showAddNewZone">
            <form role="form" class="form-group" ng-submit="saveZone(zoneObject)">
                <div class="col-lg-12 form-group" style="background-color: honeydew">
                    ...
                    <div class="col-lg-8">
                        <input type="text" ng-model="zoneObject.type" class="form-control"   required/>
                    </div>
                </div>
