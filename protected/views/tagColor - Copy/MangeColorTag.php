...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/MangeColorTag/MangeColorTag-grid.js"></script>
...
<div id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">
    ...
    <div ng-controller="manageZone" ng-init='init(<?php echo $allow_delete ?>,<?php echo $zoneList ?>,  <?php echo $companyBranchList ?> ,"<?php echo Yii::app()->createAbsoluteUrl('TagColor/saveNewTagColor'); ?>","<?php echo Yii::app()->createAbsoluteUrl('TagColor/editZone'); ?>","<?php echo Yii::app()->createAbsoluteUrl('TagColor/delete'); ?>","<?php echo Yii::app()->createAbsoluteUrl('TagColor/saveRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('TagColor/deleteRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('TagColor/search'); ?>")'>
            ...
            <div style="margin-top:0px;" class="table-responsive">
                ...
                <table id="customers">
                    ...
                    <tr ng-repeat="zone in zoneList | filter:search:stric track by $index ">
                        ...
                        <td>
                            <span ng-show="!zone.update">{{zone.tag_color_name}}</span>
                            <span ng-show="zone.update" ><input  class="form-control" type="text" ng-model="zone.tag_color_name"> </span>
                        </td>
                        <td>
                            <svg height="30" width="30" style="float: left">
                                <circle cx="12" cy="12" r="10" stroke="black" stroke-width="1" fill="{{zone.tag_color_code}}" />
                                Sorry, your browser does not support inline SVG.
                            </svg>
                            <div style="float: left">
                                <span ng-show="!zone.update">{{zone.tag_color_code}}</span>
                                <span ng-show="zone.update" ><input  class="form-control" type="text" ng-model="zone.tag_color_code"> </span>
                            </div>
