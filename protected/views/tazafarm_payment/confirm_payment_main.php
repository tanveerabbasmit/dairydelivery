...
$MerchantID ="0077879"; //Your Merchant from transaction Credentials

//$Password   ="fws295911t"; //Your Password from transaction Credentials
$Password   ="eb0f3zf04w"; //Your Password from transaction Credentials
$ReturnURL  ="https://dairydelivery.conformiz.com/tazafarm_payment/return_page"; //Your Return URL
...
$HashKey    ="yt5s4d1wyt";//Your HashKey from transaction Credentials
        ...
        <div style="margin-top:1px;padding-top:10px;padding-bottom:10px;" class="row">
           ...
           <div style="margin-top:1px;padding-top:10px;padding-bottom:10px;" class="row">
            ...
            <div class="col-sm-12" style="padding-left: 30% ; margin-top:20px" >
                ...
                <input  id="myBtn" style="color:green;width: 50%" type="submit" value="Confirm" class="btn btn-lg black btn-block">
