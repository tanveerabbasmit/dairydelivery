...
<body style="background:transparent" onload="checkValidAmount()">
    ...
    <div class=" container">
        ...
        <form action="<?= Yii::app()->baseUrl ?>/tazafarm_payment/confirm_payment" method="get">
            ...
            <div>
                ...
                <div style="margin-top:1px;padding-top:10px;padding-bottom:10px;" class="row">
                    ...
                    <div class="col-xs-7">
                        <select style="background-color: white; " class="form-control" name="pp_TxnType">
                            <option value="MWALLET">Mobile Wallet Payment</option>
                            <option value="MPAY">Card Payment</option>
