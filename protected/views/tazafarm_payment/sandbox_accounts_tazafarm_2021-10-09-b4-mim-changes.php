    ...
    <form ng-submit="proceed_function()">
        <div >
            ...
            <div class="col-sm-12" style="padding-left: 30% ; margin-top:20px" >
                ...
                <!--<a ng-disabled="valid_amount_show"  id="main_button" class="btn btn-lg black btn-block" href="<?php /*echo Yii::app()->baseUrl; */?>/tazafarm_payment/confirm_payment?client_id=<?php /*echo $client_id */?>&amount={{amount}}&outstanding_balance=<?php /*echo $outstanding_balance */?>&pp_TxnType={{pp_TxnType}}&ru=<?php /*echo $ru*/?>">Proceed</a>-->
