...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/ManageArea/customer_source_grid.js"></script>
...
<div id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">
    ...
    <div ng-controller="manageZone" ng-init='init(<?php echo $allow_delete ?>,<?php echo $zoneList ?>,  <?php echo $companyBranchList ?>
    ,"<?php echo Yii::app()->createAbsoluteUrl('CustomerSource/saveNewTagColor'); ?>","<?php echo Yii::app()->createAbsoluteUrl('CustomerSource/editZone'); ?>","<?php echo Yii::app()->createAbsoluteUrl('CustomerSource/delete'); ?>","<?php echo Yii::app()->createAbsoluteUrl('CustomerSource/saveRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('CustomerSource/deleteRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('customersource/search'); ?>")'>
            ...
            <div style="margin-top:0px;" class="table-responsive">
                ...
                <table id="customers">
                    ...
                    <tr style="background-color: #F0F8FF">
                        <th><a href="#">#</a></th>
                        <th><a href="#">Customer Source</a></th>
                    ...
                    <tr ng-repeat="zone in zoneList | filter:search:stric track by $index ">
                        ...
                        <td>
                            <span ng-show="!zone.update">{{zone.customer_source_name}}</span>
                            <span ng-show="zone.update" ><input  class="form-control" type="text" ng-model="zone.customer_source_name"> </span>
                        </td>
                        <td>
