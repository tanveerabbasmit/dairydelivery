...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/block/collectionvault_grid.js"></script>
...
<div id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">
    ...
    <div ng-controller="manageZone" ng-init='init(<?php echo $allow_delete ?>,<?php echo $zoneList ?>,  <?php echo $companyBranchList ?> ,"<?php echo Yii::app()->createAbsoluteUrl('collectionvault/save_new_collectionvault'); ?>","<?php echo Yii::app()->createAbsoluteUrl('collectionvault/edit_collectionvault'); ?>","<?php echo Yii::app()->createAbsoluteUrl('collectionvault/delete'); ?>","<?php echo Yii::app()->createAbsoluteUrl('collectionvault/saveRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('collectionvault/deleteRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('collectionvault/search'); ?>")'>
            ...
            <div style="margin-top:0px;" class="table-responsive">
                ...
                <table id="customers">
                    ...
                    <tr ng-repeat="zone in zoneList | filter:search:stric track by $index ">
                        ...
                        <td>
                            <span ng-show="!zone.update">{{zone.collection_vault_name}}</span>
                            <span ng-show="zone.update" ><input style="width: 600px" class="form-control" type="text" ng-model="zone.collection_vault_name"> </span>
                        </td>
                        <td>
