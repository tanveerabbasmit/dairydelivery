        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div class=" active" id="tab_1" style="margin: 10px">
                    ...
                    <select style="width: 15%; float: left;margin-bottom: 10px;margin-left: 10px ; margin-right: 10px" class="form-control input-sm" ng-model="selectRiderID" ng-change="changeSelectRider(selectRiderID)">
                    ...
                    <table id="customers">
                        ...
                        <tr>
                            ...
                            <th style="width:180"><a href="#">Cell No.</a></th>
                        ...
                        <tr style="background-color: {{regularOrderList.address}}" ng-repeat="regularOrderList in todayDeliveryproductList | orderBy:sortType:!sortReverse  track by $index">
                            ...
                            <td ng-show="regularOrderList.fullname" style="color: {{regularOrderList.color}} ; font-weight: bold;" >{{regularOrderList.cell_no_1}}</td >
                            ...
                            <td style="text-align: right"><span ng-bind="regularOrderList.product_list_rate"></span></td>
                            <td style="text-align: right"><span ng-bind="regularOrderList.product_quantity "></span></td>
