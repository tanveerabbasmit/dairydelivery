        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                ...
                <div class=" active" id="tab_1" style="margin: 10px">
                    ...
                    <input style="float: left ; width: 12% ;margin-bottom: 10px" class="form-control input-sm"    datetime-picker date-only  date-format="yyyy-MM-dd" type="text" required ng-model="startDate" size="2">
                    ...
                    <input ng-disabled="false" style="float: left ; width: 12% ;" class="form-control input-sm"    datetime-picker date-only  date-format="yyyy-MM-dd" type="text" required ng-model="endDate" size="2">


                    <select style="width: 12%; float: left;margin-bottom: 10px;margin-left: 10px ; margin-right: 10px" class="form-control input-sm"  ng-model="selectRiderID">
                        <option value="0">All Rider</option>
                        <option ng-repeat="list in riderList" value="{{list.rider_id}}">{{list.fullname}}
                        </option>
                    </select>

                    <select style="width: 12%; float: left;margin-bottom: 10px;margin-left: 10px ; margin-right: 10px" class="form-control input-sm" ng-model="customer_category_id" ng-change="changeSelectRider(selectRiderID)">
                        <option value="0">All Category</option>
                        <option ng-repeat="list in customerCategory" value="{{list.customer_category_id}}">{{list.category_name}}
                        </option>
                    </select>

                    <select style="width: 12%; float: left;margin-bottom: 10px;margin-left: 10px ; margin-right: 10px" class="form-control input-sm" ng-model="payment_term_id" ng-change="changeSelectRider(selectRiderID)">
                        <option value="0">Payment Term</option>
                        <option ng-repeat="list in payment_term" value="{{list.payment_term_id}}">{{list.payment_term_name}}
                        </option>
                    </select>
                    ...
                    <table id="customers">
                        ...
                        <tr>
                            ...
                            <th ><a href="#"></a></th>
                            <th style="text-align: right"><a href="#"  >{{product_quantity_total | number}}</a></th>

                             <th style="text-align: right"><a href="#" >{{final_total_amount_opening_sum | number}}</a></th>
                              <th style="text-align: right"><a href="#" >{{totaldeliverySum_current_sum | number}}</a></th>
                              <th style="text-align: right"><a href="#" >{{amountPaid | number}}</a></th>
                              <th style="text-align: right"><a href="#" >{{endDateBalance | number}}</a></th>
                              <th style="text-align: right"><a href="#" >{{totalOutStandingBalance | number}}</a></th>
