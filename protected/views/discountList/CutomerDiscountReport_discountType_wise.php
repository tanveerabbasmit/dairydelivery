...
<div  id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">
    <div ng-controller="riderDailyStockGridCtrl" ng-init='init( <?php echo $year ?> , <?php echo $monthNum ?> , <?php echo json_encode($fiveDayAgo) ?> , <?php echo $company_id ?> , <?php echo $riderList; ?>,"<?php echo Yii::app()->createAbsoluteUrl('DiscountList/discountReport'); ?>"," <?php echo Yii::app()->createAbsoluteUrl('DiscountList/googleMap');?>" ," <?php echo Yii::app()->createAbsoluteUrl('DiscountList/saveDeliveryFromPortal');?>")'>
                ...
                <div class=" active" id="tab_1" style="margin: 10px">
                    ...
                    <table id="customers">
                        ...
                        <tbody ng-repeat="regularOrderList in todayDeliveryproductList ">
                         <tr>
                             <th colspan="6" style="text-align: center ;color: green">{{regularOrderList.discount_type_name}}</th>
                         </tr>

                        <tr ng-repeat="regularOrderList in regularOrderList.result ">
                            <td>{{$index + 1}}</td>
                            ...
                            <td style="width: 150px;text-align: right"><span ng-bind="regularOrderList.amount_paid"></span></td>

                            <td style="width: 150px;text-align: right"><span ng-bind="regularOrderList.total_discount_amount"></span></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td style="text-align: right">{{regularOrderList.amount_paid |number}}</td>
                            <td style="text-align: right">{{regularOrderList.total |number}}</td>
                        </tr>
                        </tbody>
                        <tr>
                            <td></td>
                            <td></td>
                            <td>Total</td>
                            <td style="text-align: right;color: green">{{amount_paid |number}}</td>
                            <td style="text-align: right;color: green">{{total_amount |number}}</td>
                        </tr>
                    </table>
                </div>
            </div>
