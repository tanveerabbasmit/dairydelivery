...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/viewcompanystock/viewcompanystock-grid.js"></script>
...
<div class="panel row" id="testContainer" style="display: none" ng-app="clintManagemaent">
	<div ng-controller="clintManagemaent" ng-init='init( <?php echo $productList ?> , "<?php echo Yii::app()->createAbsoluteUrl('company/getCompanyStockList'); ?>")'>
		...
		<ul class="nav nav-tabs nav-tabs-lg">
			<li>
                <a  href="<?php echo Yii::app()->baseUrl; ?>/company/viewcompanystock_ledger"  type="button"   class="btn btn-primary btn-sm"> <i class=""></i> View Opening </a>
			</li>
