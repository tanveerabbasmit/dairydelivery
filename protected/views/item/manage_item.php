...
<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/viewPageJs/item/item_grid.js"></script>
...
<div id="testContainer" style="display: none"  class="panel row" ng-app="riderDailyStockGridModule">
    ...
    ,"<?php echo Yii::app()->createAbsoluteUrl('item/saveNewTagColor'); ?>","<?php echo Yii::app()->createAbsoluteUrl('item/editZone'); ?>","<?php echo Yii::app()->createAbsoluteUrl('item/delete'); ?>","<?php echo Yii::app()->createAbsoluteUrl('item/saveRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('item/deleteRiderStock'); ?>","<?php echo Yii::app()->createAbsoluteUrl('item/search'); ?>")'>
            ...
            <div style="margin-top:0px;" class="table-responsive">
                ...
                <table id="customers">
                    ...
                    <tr ng-repeat="zone in zoneList | filter:search:stric track by $index ">
                        ...
                        <td>
                            <span ng-show="!zone.update">{{zone.item_name}}</span>
                            <span ng-show="zone.update" ><input  class="form-control" type="text" ng-model="zone.item_name"> </span>
                        </td>
                        <td>
